...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// Due to scope, the function nestedFunction is able to call internal.
...
return newArray
  ...
  */
  ...
  function lowerCaseNames(array){
    const newArray = array.map(animal => {
  ...
  */
  ...
  function USApop(array){
    let num = 0
    return array.reduce( (initialValue, nextValue) => initialValue + nextValue.population, num)
